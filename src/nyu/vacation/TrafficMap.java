...
public class Map {
	public double[][] getLatLng(String startLocation, String endLocation, String days) throws Exception {
		...
		GeoApiContext context = new GeoApiContext().setApiKey("AIzaSyD4JD-2FBTdCJv7_XGDG82rYCQrkbjh9-w");
	...
	public List<String> getFIPS (double[][] latlngs) throws JSONException{
