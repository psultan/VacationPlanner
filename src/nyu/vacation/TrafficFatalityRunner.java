...
public abstract class MainRunner {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 10) {
		      ...
		      args[4] = "/home/cloudera/workspace/Traffic/Input/accident14.csv";
		      args[5] = "/home/cloudera/workspace/Traffic/output";
	    ...
	    Job severeJob = new Job(conf, "TrafficFatalityMapper");
	    severeJob.setJarByClass(MainRunner.class);
	    severeJob.setJobName("TrafficFatalityMapper");
	    FileInputFormat.addInputPath(severeJob, new Path(args[4]));
	    FileOutputFormat.setOutputPath(severeJob, new Path(args[5]));
	    severeJob.setMapperClass(TrafficFatalityMapper.class);
	    severeJob.setReducerClass(TrafficFatalityReducer.class);
